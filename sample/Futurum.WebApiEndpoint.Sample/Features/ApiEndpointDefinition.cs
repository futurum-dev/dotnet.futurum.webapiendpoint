...
public class ApiEndpointDefinition : IApiEndpointDefinition
{
    public void Configure(ApiEndpointDefinitionBuilder definitionBuilder)
    {
        definitionBuilder.Web()
                         ...
                         .Command<CommandWithRequestParameterMapFromWithResponseScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-map-from-with-response/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterMapFromWithoutResponseScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-map-from-without-response/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterMapFromWithResponseAsyncEnumerableScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-map-from-with-response-async-enumerable/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterMapFromWithResponseBytesScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-map-from-with-response-bytes/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterMapFromWithResponseDataCollectionScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-map-from-with-response-data-collection/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterMapFromWithResponseEmptyJsonScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-map-from-with-response-empty-json/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterMapFromWithResponseFileStreamScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-map-from-with-response-file-stream/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterMapFromWithResponseFileStreamWithContentTypeScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-map-from-with-response-file-stream-with-content-type/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterMapFromWithResponseStreamScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-map-from-with-response-stream/{Id}", ("Id", typeof(string))))
                         ...
                         .Command<CommandWithRequestParameterMapFromSupportedTypesScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-map-from-supported-types/{String}/{Int}/{Long}/{DateTime}", 
                                                                                                                                ("String", typeof(string)),("Int", typeof(int)), ("Long", typeof(long)), ("DateTime", typeof(DateTime))))
                         
                         .Command<CommandWithRequestParameterWithResponseScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-with-response/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterWithoutResponseScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-without-response/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterWithResponseAsyncEnumerableScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-with-response-async-enumerable/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterWithResponseBytesScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-with-response-bytes/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterWithResponseDataCollectionScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-with-response-data-collection/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterWithResponseEmptyJsonScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-with-response-empty-json/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterWithResponseFileStreamScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-with-response-file-stream/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterWithResponseFileStreamWithContentTypeScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-with-response-file-stream-with-content-type/{Id}", ("Id", typeof(string))))
                         .Command<CommandWithRequestParameterWithResponseStreamScenario.ApiEndpoint>(builder => builder.Post("command-with-request-parameter-with-response-stream/{Id}", ("Id", typeof(string))))
