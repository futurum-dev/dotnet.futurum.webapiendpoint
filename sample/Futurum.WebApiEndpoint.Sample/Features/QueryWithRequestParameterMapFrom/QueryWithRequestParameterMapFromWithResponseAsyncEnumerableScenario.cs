...
public static class QueryWithRequestParameterMapFromWithResponseAsyncEnumerableScenario
{
    ...
    public class ApiEndpoint : QueryWebApiEndpoint.Request<RequestDto, Request>.ResponseAsyncEnumerable<ApiEndpoint, FeatureDto, Feature>.Mapper<Mapper, FeatureDataMapper>
    {
