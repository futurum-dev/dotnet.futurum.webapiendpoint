...
{
    public class ApiEndpoint : CommandWebApiEndpoint.RequestUploadFileWithPayload<ApiEndpoint, PayloadDto, Payload>.ResponseAsyncEnumerable<FeatureDto, Feature>.Mapper<PayloadMapper, FeatureDataMapper>
    {
