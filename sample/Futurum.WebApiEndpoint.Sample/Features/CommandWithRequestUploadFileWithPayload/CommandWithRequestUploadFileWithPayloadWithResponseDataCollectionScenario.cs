...
public static class CommandWithRequestUploadFileWithPayloadWithResponseDataCollectionScenario
{
    ...
    {
        public override Task<Result<ResponseDataCollection<Feature>>> ExecuteAsync(RequestUploadFileWithPayload<Payload> command, CancellationToken cancellationToken) =>
