...
public static class CommandWithRequestUploadFileWithPayloadSupportedTypesScenario
{
    ...
    public class ApiEndpoint : CommandWebApiEndpoint.RequestUploadFileWithPayload<ApiEndpoint, CustomPayloadDto, CustomPayload>.Response<ResponseDto, Response>.Mapper<Mapper>
    {
