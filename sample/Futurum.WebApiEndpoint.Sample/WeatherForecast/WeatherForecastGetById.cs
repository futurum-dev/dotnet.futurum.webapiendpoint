...
public static class WeatherForecastGetById
{
    ...
    public class ApiEndpoint : QueryWebApiEndpoint.WithRequest<QueryDto, Query>.WithResponse<WeatherForecastDto, WeatherForecast>
    {
    ...
    public class Mapper : IWebApiEndpointRequestMapper<QueryDto, Query>, IWebApiEndpointResponseMapper<WeatherForecast, WeatherForecastDto>
    {
        ...
        public Result<WeatherForecastDto> Map(WeatherForecast domain) =>
