...
{
    public class ApiEndpoint : QueryWebApiEndpoint.WithoutRequest.WithResponseDataCollection<ApiEndpoint, WeatherForecastDto, WeatherForecast>.WithMapper<WeatherForecastDataMapper>
    {
