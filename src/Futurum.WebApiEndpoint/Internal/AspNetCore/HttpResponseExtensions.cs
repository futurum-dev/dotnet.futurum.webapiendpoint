...
{
    public static Task<Result> SendResponseStreamAsync(this HttpResponse httpResponse, Stream stream, int responseStatusCode, string? fileName = null, long? fileLengthBytes = null, string contentType = MediaTypeNames.Application.Octet,
    ...
    public static Task<Result> SendResponseFileAsync(this HttpResponse httpResponse, FileInfo fileInfo, int responseStatusCode, string contentType = MediaTypeNames.Application.Octet, CancellationToken cancellation = default)
    {
        async Task Execute()
        {
    ...
    public static Task<Result> SendResponseBytesAsync(this HttpResponse httpResponse, byte[] bytes, int responseStatusCode, string? fileName = null, long? fileLengthBytes = null, string contentType = MediaTypeNames.Application.Octet, CancellationToken cancellation = default)
    {
        async Task Execute()
        {
    ...
    public static Task<Result> WriteAsJsonAsync<TResponse>(this HttpResponse httpResponse, TResponse response, JsonSerializerOptions jsonSerializerOptions, int responseStatusCode, CancellationToken cancellation)
    {
        Task Execute()
        {
            httpResponse.StatusCode = responseStatusCode;
    ...
    public static Task<Result> WriteAsyncEnumerableAsJsonAsync(this HttpResponse httpResponse, object source, Type type, JsonSerializerOptions jsonSerializerOptions, int responseStatusCode, CancellationToken cancellation)
    {
        Task Execute()
        {
            httpResponse.StatusCode = responseStatusCode;
