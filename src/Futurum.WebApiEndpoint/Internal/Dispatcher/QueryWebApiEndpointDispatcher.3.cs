...
internal class QueryWebApiEndpointDispatcher<TResponseDto, TQuery, TResponse, TRequestMapper, TResponseMapper> : IWebApiEndpointDispatcher
    ...
    where TResponseMapper : IWebApiEndpointResponseMapper<TResponse, TResponseDto>
{
                                     ...
                                     IWebApiEndpoint apiEndpoint, CancellationToken cancellationToken)
    {
        ...
        var apiEndpointTyped = apiEndpoint as IQueryWebApiEndpoint<TResponseDto, TQuery, TResponse, TRequestMapper, TResponseMapper>;
