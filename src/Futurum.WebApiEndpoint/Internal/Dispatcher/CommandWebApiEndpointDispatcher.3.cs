...
internal class CommandWebApiEndpointDispatcher<TResponseDto, TCommand, TResponse> : IWebApiEndpointDispatcher
{
                                     ...
                                     CancellationToken cancellationToken)
    {
        ...
        var apiEndpointTyped = apiEndpoint as ICommandWebApiEndpoint<TResponseDto, TCommand, TResponse>;
