...
public partial class QueryWebApiEndpoint
{
    ...
    public class WithRequest<TQueryDto, TQueryDomain>
    {
        ...
        /// </summary>
        public abstract class WithResponse<TResponseDto, TResponseDomain> : IQueryWebApiEndpoint<TQueryDto, TResponseDto, TQueryDomain, TResponseDomain>
        {
            /// <inheritdoc />
        ...
        public abstract class
            WithResponseAsyncEnumerable<TApiEndpoint, TDataDto, TData> : IQueryWebApiEndpoint<TQueryDto, ResponseAsyncEnumerableDto<TDataDto>, TQueryDomain,
        ...
        /// </summary>
        public abstract class WithResponseBytes<TApiEndpoint> : IQueryWebApiEndpoint<TQueryDto, ResponseBytesDto, TQueryDomain, ResponseBytes<TApiEndpoint>>
        {
            /// <inheritdoc />
        ...
        /// </summary>
        public abstract class
            WithResponseDataCollection<TApiEndpoint, TDataDto, TData> : IQueryWebApiEndpoint<TQueryDto, ResponseDataCollectionDto<TDataDto>, TQueryDomain, ResponseDataCollection<TApiEndpoint, TData>>
        {
            /// <inheritdoc />
        ...
        /// </summary>
        public abstract class WithResponseEmptyJson<TApiEndpoint> : IQueryWebApiEndpoint<TQueryDto, ResponseEmptyJsonDto, TQueryDomain, ResponseEmptyJson<TApiEndpoint>>
        {
            /// <inheritdoc />
        ...
        /// </summary>
        public abstract class WithResponseFileStream<TApiEndpoint> : IQueryWebApiEndpoint<TQueryDto, ResponseFileStreamDto, TQueryDomain, ResponseFileStream<TApiEndpoint>>
        {
            /// <inheritdoc />
        ...
        /// </summary>
        public abstract class WithResponseStream<TApiEndpoint> : IQueryWebApiEndpoint<TQueryDto, ResponseStreamDto, TQueryDomain, ResponseStream<TApiEndpoint>>
        {
            /// <inheritdoc />
