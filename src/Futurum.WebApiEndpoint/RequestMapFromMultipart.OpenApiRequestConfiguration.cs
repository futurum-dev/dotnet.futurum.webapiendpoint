...
public class RequestMapFromMultipartOpenApiRequestConfiguration : IWebApiOpenApiRequestConfiguration
{
    public bool Check(MetadataDefinition metadataDefinition)
    {
        ...
        return requestDtoType.IsGenericType &&
               requestDtoType.GetGenericTypeDefinition() == typeof(RequestMapFromMultipartDto<>);
    }
