...
public partial class CommandWebApiEndpoint
{
    ...
    public class WithRequest<TCommandDto, TCommandDomain>
    {
        ...
        /// </summary>
        public abstract class WithoutResponse : ICommandWebApiEndpoint<TCommandDto, TCommandDomain>
        {
            /// <inheritdoc />
        ...
        /// </summary>
        public abstract class WithResponse<TResponseDto, TResponseDomain> : ICommandWebApiEndpoint<TCommandDto, TResponseDto, TCommandDomain, TResponseDomain>
        {
            /// <inheritdoc />
        ...
        public abstract class
            WithResponseAsyncEnumerable<TApiEndpoint, TDataDto, TData> : ICommandWebApiEndpoint<TCommandDto, ResponseAsyncEnumerableDto<TDataDto>, TCommandDomain,
        ...
        /// </summary>
        public abstract class WithResponseBytes<TApiEndpoint> : ICommandWebApiEndpoint<TCommandDto, ResponseBytesDto, TCommandDomain, ResponseBytes<TApiEndpoint>>
        {
            /// <inheritdoc />
        ...
        /// </summary>
        public abstract class
            WithResponseDataCollection<TApiEndpoint, TDataDto, TData> : ICommandWebApiEndpoint<TCommandDto, ResponseDataCollectionDto<TDataDto>, TCommandDomain,
        ...
        /// </summary>
        public abstract class WithResponseEmptyJson<TApiEndpoint> : ICommandWebApiEndpoint<TCommandDto, ResponseEmptyJsonDto, TCommandDomain, ResponseEmptyJson<TApiEndpoint>>
        {
            /// <inheritdoc />
        ...
        /// </summary>
        public abstract class WithResponseFileStream<TApiEndpoint> : ICommandWebApiEndpoint<TCommandDto, ResponseFileStreamDto, TCommandDomain, ResponseFileStream<TApiEndpoint>>
        {
            /// <inheritdoc />
        ...
        /// </summary>
        public abstract class WithResponseStream<TApiEndpoint> : ICommandWebApiEndpoint<TCommandDto, ResponseStreamDto, TCommandDomain, ResponseStream<TApiEndpoint>>
        {
            /// <inheritdoc />
