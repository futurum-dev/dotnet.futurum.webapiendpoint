...
public class ResponseBytesOpenApiResponseConfigurationTests
{
    public class EndpointRouteBuilder
    {
        ...
        public void check()
        {
            ...
            var metadataTypeDefinition = new MetadataTypeDefinition(null, null, typeof(ResponseBytesDto), typeof(ResponseBytesDto), null, null, null, null, null, null);
                                                ...
                                                MetadataMapFromMultipartDefinition metadataMapFromMultipartDefinition)
        {
            ...
            builder.Host.ConfigureServices((_, serviceCollection) => { serviceCollection.AddSingleton<ResponseBytesOpenApiResponseConfiguration>(); });
            ...
            var openApiResponseConfiguration = endpointRouteBuilder.ServiceProvider.GetService<ResponseBytesOpenApiResponseConfiguration>();
    ...
    public class Swashbuckle
    {
        ...
        public void check()
        {
            ...
            var openApiRequestConfiguration = new ResponseBytesOpenApiResponseConfiguration();
