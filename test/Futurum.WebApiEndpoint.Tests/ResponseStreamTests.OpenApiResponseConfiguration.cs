...
public class ResponseStreamOpenApiResponseConfigurationTests
{
    public class EndpointRouteBuilder
    {
        ...
        public void check()
        {
            ...
            var metadataTypeDefinition = new MetadataTypeDefinition(null, null, typeof(ResponseStreamDto), typeof(ResponseStreamDto), null, null, null, null, null, null);
                                                ...
                                                MetadataMapFromMultipartDefinition metadataMapFromMultipartDefinition)
        {
            ...
            builder.Host.ConfigureServices((_, serviceCollection) => { serviceCollection.AddSingleton<ResponseStreamOpenApiResponseConfiguration>(); });
            ...
            var openApiResponseConfiguration = endpointRouteBuilder.ServiceProvider.GetService<ResponseStreamOpenApiResponseConfiguration>();
    ...
    public class Swashbuckle
    {
        ...
        public void check()
        {
            ...
            var openApiRequestConfiguration = new ResponseStreamOpenApiResponseConfiguration();
