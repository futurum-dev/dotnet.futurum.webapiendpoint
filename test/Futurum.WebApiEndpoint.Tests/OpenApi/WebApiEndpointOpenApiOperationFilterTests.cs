...
public class WebApiEndpointOpenApiOperationFilterTests
{
    ...
    public class when_ManualParameterDefinitions
    {
        ...
        public void check()
        {
            ...
            var httpMethod = MetadataRouteHttpMethod.Post;
            var metadataRouteDefinition = new MetadataRouteDefinition(httpMethod, routeTemplate, null, new List<MetadataRouteParameterDefinition>{new("Id", MetadataRouteParameterDefinitionType.Path, typeof(string))}, null, 200, 400,
                                                                      Option<Action<RouteHandlerBuilder>>.None, Option<MetadataSecurityDefinition>.None);
    ...
    public class OpenApiOperationInformation
    {
        ...
        public void check()
        {
            ...
            var routeTemplate = "test-route";
            var httpMethod = MetadataRouteHttpMethod.Post;
            var metadataRouteDefinition = new MetadataRouteDefinition(httpMethod, routeTemplate, null, new List<MetadataRouteParameterDefinition>(), new MetadataRouteOpenApiOperation(summary,description), 200, 400,
                                                                      Option<Action<RouteHandlerBuilder>>.None, Option<MetadataSecurityDefinition>.None);
