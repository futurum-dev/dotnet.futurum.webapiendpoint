    ...
    public class OpenApiOperationInformation
    {
        ...
        public void check()
        {
            ...
            var metadataRouteDefinition = new MetadataRouteDefinition(httpMethod, routeTemplate, null, new List<MetadataRouteParameterDefinition>(),
                                                                      new MetadataRouteOpenApiOperation(summary, description, deprecated, new MetadataRouteOpenApiExternalDocs(externalDocsDescription, externalDocsUrl)), 200, 400,
            ...
            openApiOperation.Deprecated.Should().Be(deprecated);
