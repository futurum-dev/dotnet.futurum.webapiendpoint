...
public class RequestMapFromMultipartOpenApiRequestConfigurationTests
{
    public class EndpointRouteBuilder
    {
                                                ...
                                                MetadataMapFromMultipartDefinition metadataMapFromMultipartDefinition)
        {
            ...
            builder.Host.ConfigureServices((_, serviceCollection) => { serviceCollection.AddSingleton<RequestMapFromMultipartOpenApiRequestConfiguration>(); });
            ...
            var openApiRequestConfiguration = endpointRouteBuilder.ServiceProvider.GetService<RequestMapFromMultipartOpenApiRequestConfiguration>();
    ...
    public class Swashbuckle
    {
        ...
        public void check()
        {
            var openApiRequestConfiguration = new RequestMapFromMultipartOpenApiRequestConfiguration();
