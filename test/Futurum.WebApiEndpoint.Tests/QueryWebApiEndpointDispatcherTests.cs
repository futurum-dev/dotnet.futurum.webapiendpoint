...
//
//             var metadataTypeDefinition = new MetadataTypeDefinition(typeof(QueryDto),typeof(QueryDto), typeof(ResponseDto),typeof(ResponseDto),typeof(ApiEndpoint),
...
//                                                                     typeof(WebApiEndpointDispatcher<ResponseDto, Query, Response, Mapper, Mapper>),
//                                                                     new List<Type>());
...
//
//             var queryWebApiEndpointDispatcher = mocker.CreateInstance<WebApiEndpointDispatcher<ResponseDto, Query, Response, Mapper, Mapper>>();
//
...
//         {
//             public Task<Result<Query>> MapAsync(HttpContext httpContext, MetadataDefinition metadataDefinition, CancellationToken cancellationToken) =>
//                 new Query().ToResultOkAsync();
//
...
//                                                                     typeof(IWebApiEndpointMiddlewareExecutor<Query, Response>),
//                                                                     typeof(WebApiEndpointDispatcher<QueryDto, ResponseDto, Query, Response, Mapper, Mapper>),
//                                                                     new List<Type>());
//             var metadataMapFromDefinition = new MetadataMapFromDefinition(new List<MetadataMapFromParameterDefinition>());
//             var metadataMapFromMultipartDefinition = new MetadataMapFromMultipartDefinition(new List<MetadataMapFromMultipartParameterDefinition>());
//             var metadataDefinition = new MetadataDefinition(MetadataRouteDefinition, metadataTypeDefinition, metadataMapFromDefinition, metadataMapFromMultipartDefinition);
...
//             var middlewareExecutor = new DisabledWebApiEndpointMiddlewareExecutor<Query, Response>();
//
//             var queryWebApiEndpointDispatcher = mocker.CreateInstance<WebApiEndpointDispatcher<QueryDto, ResponseDto, Query, Response, Mapper, Mapper>>();
//
//             return await queryWebApiEndpointDispatcher.ExecuteAsync(metadataDefinition, httpContext, middlewareExecutor, apiEndpoint, CancellationToken.None);
//         }
//
