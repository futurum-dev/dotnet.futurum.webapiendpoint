...
public class ResponseAsyncEnumerableOpenApiRequestConfigurationTests
{
    [Fact]
    public void check()
    {
        ...
        var metadataTypeDefinition = new MetadataTypeDefinition(null, null, typeof(ResponseAsyncEnumerableDto<int>), typeof(int), null, null, null, null, null, null);
                                            ...
                                            MetadataMapFromMultipartDefinition metadataMapFromMultipartDefinition)
    {
        ...
        {
            serviceCollection.AddSingleton<ResponseAsyncEnumerableOpenApiResponseConfiguration>();
        });
        ...
        var openApiResponseConfiguration = endpointRouteBuilder.ServiceProvider.GetService<ResponseAsyncEnumerableOpenApiResponseConfiguration>();
