...
public class RequestUploadFilesOpenApiRequestConfigurationTests
{
    public class EndpointRouteBuilder
    {
        ...
        public void check()
        {
            var metadataTypeDefinition = new MetadataTypeDefinition(typeof(RequestUploadFilesDto), null, null, null, null, null, null, null, null, null);
                                                ...
                                                MetadataMapFromMultipartDefinition metadataMapFromMultipartDefinition)
        {
            ...
            builder.Host.ConfigureServices((_, serviceCollection) => { serviceCollection.AddSingleton<RequestUploadFilesOpenApiRequestConfiguration>(); });
            ...
            var openApiRequestConfiguration = endpointRouteBuilder.ServiceProvider.GetService<RequestUploadFilesOpenApiRequestConfiguration>();
    ...
    public class Swashbuckle
    {
        ...
        public void check()
        {
            var openApiRequestConfiguration = new RequestUploadFilesOpenApiRequestConfiguration();
